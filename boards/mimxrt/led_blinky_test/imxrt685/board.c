...
#define BOARD_IS_XIP_FLEXSPI()                                                                                  \
    ((((uint32_t)BOARD_InitBootPins >= 0x08000000U) && ((uint32_t)BOARD_InitBootPins < 0x10000000U)) || \
     (((uint32_t)BOARD_InitBootPins >= 0x18000000U) && ((uint32_t)BOARD_InitBootPins < 0x20000000U)))
#endif
/*******************************************************************************
 * Variables
 ******************************************************************************/
